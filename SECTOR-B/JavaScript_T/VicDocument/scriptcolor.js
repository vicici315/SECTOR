...
'BlockingCollection|ConcurrentBag|ConcurrentDictionary|ConcurrentQueue|ConcurrentStack|OrderablePartitioner|Partitioner'; //��ʱ����
...
'package|class|interface|instanceof|as|override|get|set|prototype|dynamic|final|internal|public|private|protected|static|implements'; //���Ϊ as3
