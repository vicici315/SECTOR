Shader "FGame/Particles/Anim Alpha Blended" {
Properties {
    ...
    SubShader {
        Pass {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 colA = g_Tex2D_ColorAlpha(_MainTex, i.texcoord);
                fixed4 colB = g_Tex2D_ColorAlpha(_MainTex, i.texcoord2);
